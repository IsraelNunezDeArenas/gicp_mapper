...
def generate_launch_description():
    ...
    args = [
        ...
        # Guardado
        DeclareLaunchArgument("save_path",   default_value="/tmp/vgicp_map.ply"),

        DeclareLaunchArgument("voxel_resolution",   default_value="1.0"),
        DeclareLaunchArgument("source_max_points",   default_value="5000"),
    ]

    node = Node(
        package="gicp_mapper",
        executable="vgicp_mapper_node",
        name="vgicp_mapper",
        output="screen",
        parameters=[{
